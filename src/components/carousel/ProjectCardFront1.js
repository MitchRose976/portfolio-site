...
import Pic from "../../images/ImperialAquila.jpg";
...
const ProjectCardFront = ({ isFlipped, flipCard }) => {
  ...
  return (
    ...
    >
      ...
      >
        <ProjectTitle>Warhammer 40k Army List Builder</ProjectTitle>
        <ProjectDescription className="frontText">
          This is a project I built using Vanilla JS, CSS, and HTML
        </ProjectDescription>
        <button 
